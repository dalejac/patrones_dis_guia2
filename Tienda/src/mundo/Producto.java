...
public class Producto {
    ...
    public double calcularPrecioFinal() {
        ...
        switch (tipo) {
            case "supermercado":
                precioFinal = valorUnitario + darIVA();
                break;
            case "drogueria":
                precioFinal = valorUnitario + darIVA();
                break;
    ...
    public double darIVA() {
        ...
        switch (tipo) {
            case "supermercado":
                iva = valorUnitario * 0.04;
                break;
            case "drogueria":
                iva = valorUnitario * 0.12;
                break;
            case "papeleria":
                iva = valorUnitario * 0.16;
                break;
        }
        return iva;
    }
    ...
    public int vender(int pCantidad) {
        ...
        if (pCantidad > this.cantidadBodega){
            cantidadVendida = cantidadBodega;
            cantidadBodega = 0;
        } else {
            cantidadVendida = pCantidad - cantidadBodega;
        }

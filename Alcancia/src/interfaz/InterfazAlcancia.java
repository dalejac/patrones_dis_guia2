...
public class InterfazAlcancia extends JFrame {
    ...
    public void nuevaAlcancia() {
        ...
        panelAlcancia.cambiarMensaje("La alcanc�a est� vac�a.");
    ...
    public void reqFunc1() {
        ...
        JOptionPane.showMessageDialog(this,
                "La moneda m�s numerosa en la alcanc�a es la de " + resultado + " pesos",
                "Respuesta",
    ...
    public void reqFunc2() {
        String resultado;
        if (alcancia.valiosa()) {
            resultado = "La alcanc�a es valiosa, solo posee monedas de 500 y de 1000";
        }
        else {
